...
async function requestJson(url, options = {}) {
  if (window.SIGNALROOM_BROWSER_API && (location.hostname.endsWith("github.io") || new URLSearchParams(location.search).has("static"))) {
    return window.SIGNALROOM_BROWSER_API(url, options);
  }
...
if (window.SIGNALROOM_BROWSER_API && (location.hostname.endsWith("github.io") || params.has("static"))) {
  document.querySelectorAll(".api-reference").forEach((link) => {
    link.href = "https://github.com/sutasmantas/retention-decisioning";
